  ...
  return (
    <main className="content content--single">
      <section id="about">
        ...
        <p>
          <img src={UnderCon} alt="test" className="image__undercon" />
        ...
        <p>
          <img src="https://source.unsplash.com/random/100x100" alt="test" className="image__php" />
        ...
        <p>
          <img src="https://source.unsplash.com/random/200x200" alt="test" className="image__js" />
