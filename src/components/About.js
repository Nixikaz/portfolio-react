  ...
  return (
    <main className="content content--single">
      <section>
        ...
        <p><img src="https://source.unsplash.com/random/160x160" alt="test" className="image__undercon" />
        ...
        <p><img src="https://source.unsplash.com/random/100x100" alt="test" className="image__php" />
          Around 2003 I tried my hand at web development again. This time around I started to learn to develop in PHP
          using MySQL as a back-end. I designed this website to use CRUD operations to manage my content. At this time I
          was still only using tables for layout. I had not used CSS until 2005 while I was taking an HTML class in art
          school.
        </p>
        <p><img src="https://source.unsplash.com/random/200x200" alt="test" className="image__js" />
          ...
          career in web development. Now I am starting to learn React and eventually would like to evolve into a full
          stack developer.
        </p>
        <p />
      </section>
