  ...
  render() {
    ...
    return (
      <main className="content">
        <Spring from={animateFrom} to={animateTo} config={{ delay: 1300, duration: 300, tension: 100, friction: 14 }}>
          {props => (
        ...
        <Spring from={animateFrom} to={animateTo} config={{ delay: 1600, duration: 300 }}>
          {props => (
            <section className="card__section" style={props}>
              <Css />
            </section>
